...
class DataPipeline:
    def __init__(self, users_file=None, feedback_file=None):
        base_dir = os.path.dirname(os.path.abspath(__file__))
        self.users_file = users_file or os.path.join(base_dir, 'users.csv')
        self.feedback_file = feedback_file or os.path.join(base_dir, 'feedback.csv')
        self.users_df = None
    ...
    def load_data(self):
        ...
        if not os.path.exists(self.users_file):
            raise FileNotFoundError(f"users_file not found: {self.users_file}")
